        ...
        if($BlogWorthy_todaysingleid == 0) {
            ...
            if (in_array($cd->cat_ID, $all_catid)){
                ...
                if (in_array($BlogWorthy_todaysingleid, $all_postid)) {
                    ...
                    $tempTodayItem = CreateListItem( $BlogWorthy_todaypagepath[$BlogWorthy_todaysingleid], $titleStr, $image[0], $contentStr, $BlogWorthy_todaypageviews[$BlogWorthy_todaysingleid] );
                    array_push($todayArray, $tempTodayItem);
